...
class Stream:
    """
    Represents a stream in the network.
    ...
    def __init__(self, stream_id):
        """
        Initializes a Stream object with a given stream ID.
...
class ReadyQueue:
    """
    Represents a ready queue in the network.
    
    Attributes:
        queue_id (int): The unique identifier for the ready queue.
    """
    def __init__(self, queue_id):
        """
        Initializes a ReadyQueue object with a given queue ID.
